...
internal static class TinyJsonExtensions
{
	...
	//{
	//	ProxyArray array = entry.GetString(fieldName) as ProxyArray;
	//	if (array == null)
	//	{
	...
	//{
	//	var checkArray = jsonDict.GetVariantOrNull(className, fieldName);
	//	if (checkArray == null)
	//	{
	//		return new ProxyArray();
	//	}
	...
	//{
	//	return jsonDict.GetProxyArray(className, fieldName).ConvertToFloatArray();
	//}
	...
	//internal static int[] GetArray<int>(this ProxyObject dict, string className, string fieldName)
	//{
	//	return jsonDict.GetProxyArray(className, fieldName).ConvertToIntArray();
	//}
	...
	//internal static string[] GetArray<string>(this ProxyObject dict, string className, string fieldName)
	//{
	//	return jsonDict.GetProxyArray(className, fieldName).ConvertToStringArray();
	//}

	//internal static string[] GetArray<string>OrEmpty(this ProxyObject dict, string className, string fieldName)
	//{
	//	return jsonDict.GetProxyArrayOrEmpty(className, fieldName).ConvertToStringArray();
	//}
	...
	//{
	//	return entry.GetString(fieldName).ConvertToVector3();
	//}
}
